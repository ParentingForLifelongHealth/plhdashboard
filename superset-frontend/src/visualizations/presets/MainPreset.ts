  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new TimeSnapshotFilterPlugin().configure({
          key: FilterPlugins.TimeSnapshot,
        }),
        ...
        new ColumnTimeRangeFilterPlugin().configure({
          key: FilterPlugins.ColumnTimeRange,
        }),
